...
function Toggle({ id, label, onToggle, defaultOn = false }) {
  ...
  return (
    <div
      style={{
        ...
        padding: "10px 0",
        borderBottom: "1px dashed #b0b090",
      }}
    >
      <span
        className="font-mono"
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <span
          className="font-mono"
          style={{ fontSize: 11, color: "#3a5a30", minWidth: 24 }}
        >
          {on ? "ON" : "OFF"}
        </span>
      </div>
  ...
  return (
    <div>
      ...
      <InfoRow
        label="📧 Email"
        value={
          <a href="mailto:supisa.wo@gmail.com" style={{ color: "#1a5c4a" }}>
            supisa.wo@gmail.com
          </a>
        }
      />
      <InfoRow
        label="📞 Phone"
        value={
          <a href="tel:+66826196949" style={{ color: "#1a5c4a" }}>
            +66 82-619-6949
          </a>
        }
      />
      ...
      >
        <a className="contact-btn" href="mailto:supisa.wo@gmail.com">
          📧 Send Email
        </a>
        <a className="contact-btn" href="tel:+66826196949">
          📞 Call Me
        </a>
      </div>
